...
public class DictionaryTest {
    private static void stressTest() {
        Dictionary<Integer, Integer> hashDictionary =
                new HashDictionary<Integer, Integer>();
    ...
    private static Dictionary<String, Integer> createTreeDictionary() {
        Dictionary<String, Integer> dictionary = (Dictionary<String, Integer>)
                new TreeSetDictionary<String, Integer>();
